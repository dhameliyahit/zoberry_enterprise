        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href="tel:9638601192" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
              ...
              <li>
                <a href="mailto:support@zoberryenterprise.shop" className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              ...
              <li>
                <Link className="ease-out duration-200 hover:text-blue" href="/shop-without-sidebar">
                  Shop
                </Link>
              </li>
            </ul>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <Link className="ease-out duration-200 hover:text-blue" href="/about">
                  About Us
                </Link>
              </li>
              <li>
