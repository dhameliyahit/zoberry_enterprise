...
const ShopDetails = () => {
  ...
  // Sync Redux store to localStorage whenever the active product changes/updates
  useEffect(() => {
    if (product?._id) {
                      ...
                      <div className="flex items-center gap-1">
                        {Array.from({ length: 5 }).map((_, index) => {
                          ...
                          return (
                            <svg
                              key={index}
                              className={isFilled ? "fill-[#FFA645]" : "fill-[#E2E8F0]"}
                              width="18"
                              height="18"
                              viewBox="0 0 18 18"
                              fill="none"
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-1">
                                {Array.from({ length: 5 }).map((_, index) => {
                                  ...
                                  return (
                                    <span key={index} className={isFilled ? "text-[#FBB040]" : "text-gray-4"}>
                                      <svg
                                        className="fill-current"
                                        width="15"
                                        height="16"
                            ...
                            return (
                              <span
                                ...
                                className={`cursor-pointer transition-colors duration-150 ${
                                  isFilled ? "text-[#FBB040]" : "text-gray-4 hover:text-[#FBB040]"
                                }`}
                              >
                                <svg
                                  className="fill-current"
