...
const Categories = () => {
  ...
  return (
    <section id="categories" className="overflow-hidden pt-17.5">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-15 border-b border-gray-3">
        <div className="swiper categories-carousel common-carousel">
          ...
          {categories.length > 0 && categories.length <= 6 ? (
            <div className="flex flex-wrap items-center justify-start gap-6 sm:gap-7.5 md:gap-9 py-2">
              {categories.map((item, key) => (
                <div key={key} className="w-[120px] sm:w-[140px] shrink-0">
